$(function() {
	...
	! function(n, e, i, a) {
		n.navigation = function(t, s) {
			...
			u.settings = {};
			var t = (n(t), t);
			n(t).find(".nav-menus-wrapper").prepend("<span class='nav-menus-wrapper-close-button'>вњ•</span>"), n(t).find(".nav-search").length > 0 && n(t).find(".nav-search").find("form").prepend("<span class='nav-search-close-button'>вњ•</span>"), u.init = function() {
	...
	// Card's slider
	  ...
	  $carousel
		...
		.magnificPopup({
		  ...
		  image: {
			verticalFit: true,
			tError: '<a href="%url%">Р¤РѕС‚Рѕ #%curr%</a> РЅРµ Р·Р°РіСЂСѓР·РёР»РѕСЃСЊ.'
		  },
		  gallery: {
			enabled: true,
			navigateByImgClick: true,
			tCounter: '<span class="mfp-counter">%curr% РёР· %total%</span>', // markup of counte
